...
- `make docker-fix-phpstan-baseline`: Generate PHPStan baseline.
- `make docker-run-rector`: Run Rector for code modernization (dry run).
- `make docker-fix-rector`: Apply Rector fixes for code modernization.
...
- **Generating PHPStan baseline**: `make docker-fix-phpstan-baseline`
- **Running Rector (dry run)**: `make docker-run-rector`
- **Applying Rector fixes**: `make docker-fix-rector`
