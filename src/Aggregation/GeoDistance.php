...
class GeoDistance extends AbstractAggregation
{
     ...
     * @param array<string, float>|array<int, float>|string $origin the point from which distances will be calculated
     */
     ...
     *
     * @param array<string, float>|array<int, float>|string $origin valid formats are array("lat" => 52.3760, "lon" => 4.894), "52.3760, 4.894", and array(4.894, 52.3760)
     *
     * @return $this
     */
