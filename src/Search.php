...
class Search
{
    ...
    public function setOptionsAndQuery($options = null, $query = ''): self
    {
        ...
        if (\is_int($options)) {
            \trigger_deprecation('ruflin/elastica', '7.1.3', 'Passing an int as 1st argument to "%s()" is deprecated, pass an array with the key "limit" instead. It will be removed in 8.0.', __METHOD__);
